...
to Setup
  ...
  ;JA: Can we put a namelist at the very beginning of the code where users can change parameter values, such as the legend location?
  ;-----Namelist to have variables set by the user-----------------------------------------
  ;Where to have the legend displayed on the Netlogo interface
  let legend-location 1  ;1=upper-right...2=upper-left...3=lower-left...4=lower-right
  if legend-location = 1 [import-drawing "Legend/Legend_Upper_Right.png"]
  if legend-location = 2 [import-drawing "Legend/Legend_Upper_Left.png"]
  if legend-location = 3 [import-drawing "Legend/Legend_Lower_Left.png"]
  if legend-location = 4 [import-drawing "Legend/Legend_Lower_Right.png"]
