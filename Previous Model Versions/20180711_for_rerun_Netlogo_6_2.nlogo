...
__includes ["./components/move-hurricane.nls" "./components/new-last-records.nls" "./components/coastal-patch-alerts.nls" "./components/issue-alerts.nls" "./components/dm.nls" "./components/load-gis.nls" "./components/load-hurricane.nls" "./components/create-agents.nls" "./components/generate-storm.nls" "./components/load-forecasts.nls"]
...
set output-filename "short-tests"</setup>
  ...
  <experiment name="experiment_test_wind" repetitions="100" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-wind-3"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="latest">
      <value value="0"/>
  ...
  <experiment name="experiment_test_wind_no" repetitions="100" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
