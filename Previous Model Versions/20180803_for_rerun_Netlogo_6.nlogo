...
;; shows histogram counts for 90 hours out till 18 hours past landfall
   ...
   let op (sentence "" which-storm? distribute_population network-distance network-size earliest wind_threshold forc-w evac-w envc-w allpct "|" output-list-a "|" hist-list "|" hist-pcts "|")
...
set output-filename "exp-test-network"</setup>
  ...
  <experiment name="experiment_test_network2" repetitions="500" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-network2"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="latest">
      <value value="0"/>
  ...
  <experiment name="experiment_test_network3" repetitions="1000" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-network2"</setup>
  ...
  <experiment name="experiment_test_network4" repetitions="500" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-network4"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="latest">
      <value value="0"/>
