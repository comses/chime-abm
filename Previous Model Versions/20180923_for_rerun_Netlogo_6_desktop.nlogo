...
gis:load-coordinate-system "REGION/FLORIDA/GIS/block_density.prj"                  ; NetLogo needs a prj file to set up the conversion from GIS to netlogo grid
      ...
      set mean_income gis:load-dataset "REGION/FLORIDA/GIS/median_income_FL_2011.asc" ; Raster map Mean HH Annual Income, calculated with census data from 2011. Split into 4 divisions, 4 is high income, 1 is low
...
set output-filename "wilma_ideal"</setup>
  ...
  <experiment name="wealth_experiment" repetitions="2" runMetricsEveryStep="true">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-wealth"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="latest">
      <value value="0"/>
