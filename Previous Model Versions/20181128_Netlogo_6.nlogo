...
set output-filename "exp-test-network"</setup>
  ...
  <experiment name="basic_experiment" repetitions="100" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test"</setup>
  ...
  <experiment name="experiment_181128_networks" repetitions="100" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-networks-181128"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="#broadcasters">
      <value value="10"/>
