...
;;  - double check the dimensions of the window
...
tracts-own [
  tract-information ;; GIS data attributes
  ]
...
to check-for-swimmers
   let this-elev [elev] of patch-here
    if isNAN this-elev [
    ;; move agent located in teh water to the nearest land
...
to load-tracts
  ...
  foreach feature-list [ ?1 ->
    ...
    create-tracts 1 [ ;; initialize an agent to represent a site in the simulation
