;;;;;;;;;;;;;;;;;;TODO;;;;;;;;;;;;;;;;;;;;;
;;  - make the tract agents the citizen agents
;;  X make a mehtod to move the swimming agents move to land
;;  X double check the dimensions of the window
;;  - pull in data for the number of citizens for each tract
;;  - record some of the data for the new tract/ cit / ags
...
to create-tract-agents
  ...
  let sitesfile "flcensusdata/FLTRACTpoint2.shp"
...
;; shows histogram counts for 90 hours out till 18 hours past landfall
   ...
   let op (sentence "" which-storm? distribute_population earliest wind_threshold forc-w evac-w envc-w allpct network-distance network-size"|" output-list-a "|" hist-list "|" hist-pcts "|")
...
set output-filename "exp-test"</setup>
  ...
  <experiment name="experiment_20181213_cenusus_affects_under_5" repetitions="500" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
set output-filename "exp-test-under5-effect"</setup>
  ...
  <experiment name="experiment_20181213_cenusus_affects_over_74" repetitions="500" runMetricsEveryStep="false">
    <setup>load-gis
load-hurricane
load-forecasts
setup
