...
;  movie-grab-view  ;; adds frame to the movie (usually disabled)
  if ticks = 135 [
    ;movie-close
    set output-filename "exp-irma-20190422-Irma-high"
...
to add-temp-factor-test
  ask cit-ags [set kids-under-18? false]
  let total-cits count cit-ags
  let cit-ags-with-factor test-factor-proportion * total-cits
  ask n-of cit-ags-with-factor cit-ags [set kids-under-18? true]
end
...
;; shows histogram counts for 90 hours out till 18 hours past landfall
   ...
   let op (sentence "" which-storm? distribute_population earliest wind_threshold forc-w evac-w envc-w allpct network-distance network-size test-factor-proportion under-18-assessment-increase "|" output-list-a "|" hist-list "|" hist-pcts "|")
...
set output-filename "exp-irma-census-over74-3"</setup>
  ...
  <experiment name="experiment_20190422_Irma_under18_factor_test_1" repetitions="25" runMetricsEveryStep="false">
    <setup>load-gis-hpc
load-hurricane-hpc
load-forecasts-hpc
setup
set output-filename "exp-irma-20190422-Irma-factor-test1"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
...
set output-filename "exp-irma-20190422-Irma-all5"</setup>
  ...
  <experiment name="experiment_20190422_Irma_under18" repetitions="100" runMetricsEveryStep="false">
    <setup>load-gis-hpc
load-hurricane-hpc
load-forecasts-hpc
setup
set output-filename "exp-irma-20190422-Irma-under18"</setup>
  ...
  <experiment name="experiment_20190422_Irma_under18_factor_test_2" repetitions="25" runMetricsEveryStep="false">
    <setup>load-gis-hpc
load-hurricane-hpc
load-forecasts-hpc
setup
set output-filename "exp-irma-20190422-Irma-factor-test3"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
    <enumeratedValueSet variable="kids-under-18-factor">
      <value value="true"/>
