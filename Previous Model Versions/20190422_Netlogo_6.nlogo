...
;  movie-grab-view  ;; adds frame to the movie (usually disabled)
  if ticks = 135 [
    ;movie-close
    ;set output-filename "exp-irma-20190422-Irma"
...
set output-filename "exp-irma-20190422-Irma-under18"</setup>
  ...
  <experiment name="experiment_20190723_charley_real_old_cone" repetitions="50" runMetricsEveryStep="false">
    <setup>load-gis-hpc
load-hurricane-hpc
load-forecasts-hpc
setup
set output-filename "20190723-charley-old-cone"</setup>
    <go>go</go>
    <metric>new-last-records</metric>
